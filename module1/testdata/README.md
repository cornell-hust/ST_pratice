...
`cron_cases.json` 是 40 条清单用例（编号区间 CRON-UT-001—052；已删除 012、015、023、026—032、036、041；原 5 条专项检查并入为 041—050，另新增 051—052 夏令时用例）的**单一数据源**：用例的表达式、起始时间与预期结果全部记录在此，测试代码不写死任何用例数据（"数据带着代码"，设计动机见 `module1/自动化测试设计与实施说明v2.md`）。
